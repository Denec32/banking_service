...
public class TransactionCheckConfig {
    ...
    @Bean
    public TransactionCheckWebClient checkWebClient(ClientHttp clientHttp) {
        WebClient.Builder webClient = WebClient.builder();
        webClient
                .baseUrl(url)
                .clientConnector(clientHttp.getClientHttp(TransactionCheckWebClient.class.getName()));
        return new TransactionCheckWebClient(webClient.build());
    }
